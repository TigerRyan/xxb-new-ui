<template>
  <div class="xxb-select-item">
    <div class="xxb-select-line"></div>

    <div class="xxb-select-list">
      <ul class="xxb-select-ul" ref="list">
        <li class="xxb-select-list-item" v-for="el,index in renderData " :class="{'hidden':setHidden(el.index)}" :key="index">{{el.value}}</li>
      </ul>
    </div>
    
    <ul class="xxb-select-wheel" ref="wheel">
      <li class="xxb-select-wheel-item" :class="{'hidden':setHidden(el.index)}" :style="setWheelItemDeg(el.index)" :index="el.index" v-for="el,index in renderData " :key="index">{{el.value}}</li>
    </ul>
  </div>
</template>
<script>
